...
### Licenciado em Engenharia Informática (UMinho) | Futuro Mestrando em IA
Acabei de concluir a minha Licenciatura em Engenharia Informática na **Universidade do Minho** e sou candidato/futuro estudante de Mestrado em IA. O meu foco é o desenvolvimento de software robusto, arquitetura de sistemas e a aplicação prática de Inteligência Artificial para otimizar fluxos de trabalho.

🚀 **Próximo Passo:** Fui selecionado para o prestigiado programa de estágio de verão **JumpIn na BOSCH (Braga)** para os meses de julho e agosto de 2026, onde irei trabalhar com desenvolvimento de software e integração de IA em ambiente corporativo.
...
### ⚙️ DevOps, Infraestrutura & Data Science
...
## 🚀 Projetos em Destaque (Casos de Estudo Técnicos)

Aqui estão os principais projetos académicos e pessoais que desenvolvi durante a licenciatura, focados em algoritmos complexos, arquitetura e qualidade de código:

### 🚕 TaxiGreen — Otimização de Frota Multi-Agente
...
## ⏳ Percurso & Próximos Desafios

*   🎓 **Mestrado em Inteligência Artificial** | *Universidade do Minho* (Previsão: Set 2026)
    *   Foco planeado: Machine Learning avançado, Processamento de Linguagem Natural (LLMs) e Agentes Inteligentes aplicados à engenharia de software.
*   💼 **BOSCH Car Multimedia Portugal** | *Estagiário de Engenharia de Software — Programa JumpIn* (Jul 2026 - Ago 2026)
    *   Focado em otimização de soluções e fluxos de trabalho avançados com a aplicação de IA para acelerar a entrega de software.
*   🎓 **Licenciatura em Engenharia Informática** | *Universidade do Minho* (Concluída: Jun 2026)
    *   Base sólida em algoritmos, estruturas de dados, redes e engenharia de software. Participação no Hackathon 2025 do CESIUM.
*   💼 **BOSCH Car Multimedia Portugal** | *Estagiário de Verão — Controlo de Qualidade* (Jun 2023 - Ago 2023)
    *   Análise de dados de processos com Tableau, monitorização de métricas e workshops de liderança/produtividade.
